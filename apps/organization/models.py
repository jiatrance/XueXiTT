...
class CityDict(models.Model):
    name=models.CharField('语言',max_length=20)
...
class CourseOrg(models.Model):
    ...
    image = models.ImageField('封面', upload_to='org/%Y%m', max_length=100,null=True,blank=True)
    address=models.CharField('机构地址',max_length=150)
    city=models.ForeignKey(CityDict,verbose_name='语言类型',on_delete=models.CASCADE)
    add_time=models.DateTimeField(default=datetime.now)
